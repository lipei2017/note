...
2. 基于特定版本迁出 hotfix 分支，如：hotfix/v2.1.0.0/20220531

```sh
git checkout -b hotfix/v2.1.0.0/20220531 v2.1.0.0
```

3. 修复完毕，推送到远程提测分支

```sh
git push origin hotfix/v2.1.0.0/20220531
```

4. 测试完毕，打 tag，并推送到远程

```sh
(hotfix/v2.1.0.0/20220531)
git tag -a v2.1.1.0 -m"修复项目功能"
git push origin v2.1.1.0
```
